...
// Load the html file
var $ = cheerio.load(fs.readFileSync(__dirname + '/html/index.html','utf8'));
var facebookHtml = cheerio.load(fs.readFileSync(__dirname + '/html/tweetPlaceHolder.html','utf8'));
// Serve at port 8081
